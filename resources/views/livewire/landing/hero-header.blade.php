<div class="max-w-[400px] md:max-w-[1140px] m-auto">
    @if ($data)
        ...
        <div class="flex justify-center my-[150px] content-center flex-wrap w-full md:w-[50%] mx-auto text-center relative">
            ...
            <h2 class="font-Inconsolata-Black text-[2rem] w-full">{{ $item->title }}</h2>
